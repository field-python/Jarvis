...
MENU = [
    ...
    ("🔩  System",      ["__submenu__", "system"],   False, ""),
]
...
SUBMENUS = {
    ...
    "life": [
        ...
        ("📢  Speech & Writing",  ["__submenu__", "writing"],  False, ""),
        ("📊  Pros & Cons",       ["pros"],                    True,  "Decision or topic: "),
        ("🧒  Explain simply",    ["eli5"],                    True,  "Topic: "),
        ("🔀  Compare two things",["compare"],                 True,  "X vs Y: "),
        ("📍  Action plan",       ["plan"],                    True,  "Goal or project: "),
    ...
    "library": [
        ...
        ("🎭  Classic Library",   ["__submenu__", "classics"],   False, ""),
    ...
    "holy_books": [
        ("📖  Bible (KJV)",          ["holybooks", "bible"],           False, ""),
        ("🔯  Torah (JPS)",          ["holybooks", "torah"],           False, ""),
        ("🌙  Quran",                ["holybooks", "quran"],           False, ""),
        ("📗  Book of Mormon",       ["holybooks", "book of mormon"],  False, ""),
        ("🌺  Bhagavad Gita",        ["holybooks", "bhagavad gita"],   False, ""),
        ("🌿  Tao Te Ching",         ["holybooks", "tao te ching"],    False, ""),
        ("🕍  Talmud / Mishnah",     ["holybooks", "talmud"],          False, ""),
        ("🔱  Rig Veda",             ["holybooks", "rig veda"],        False, ""),
        ("🧘  Upanishads",           ["holybooks", "upanishads"],      False, ""),
        ("🙏  Dhammapada",           ["holybooks", "dhammapada"],      False, ""),
    ...
    "classics": [
        ...
        ("🧭  Adventure",                    ["__submenu__", "classics_adventure"],False, ""),
        ...
        ("📜  Philosophy & Strategy",        ["__submenu__", "classics_phil"],    False, ""),
    ...
    "reminders": [
        ...
        ("🚮  Delete a reminder",    ["remind", "delete"],      True,  "Reminder #: "),
        ("🔁  Start reminder daemon", ["remind-start"],         False, ""),
    ],
    "writing": [
        ("📢  Speech writer",        ["speech"],      False, ""),
